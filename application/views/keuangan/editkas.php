                ...
                <tbody>
                     <form action="<?= base_url('keuangan/savepemasukancart'); ?>" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" class="badge badge-success" data-toggle="modal" data-target="#newPemasukanModal<?= $m['id'] ?>"><i class="far fa-fw fa-edit"></i></a>
...
<!-- edit Modal -->
<?php foreach ($keuangan as $kk) : ?>
<?php foreach ($kk as $k) : ?>
<div class="modal fade" id="newPemasukanModal<?= $k['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="newPemasukanModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newPemasukanModalLabel">Edit Kas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('keuangan/simpanKasDetail/'.$k['id'].'/'.$idkasnow); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" value="<?= $k['jumlah'] ?>" id="jumlah" name="jumlah" placeholder="Jumlah terjual">
                    <input type="hidden" name="idkas" value="<?= $idkas?>">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" value="<?= $k['keterangan'] ?>" id="keterangan" name="keterangan" placeholder="keterangan">
                    </div>
